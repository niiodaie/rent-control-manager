          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@rent-control.net" className="text-gray-300 hover:text-white transition-colors">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+19208081188" className="text-gray-300 hover:text-white transition-colors">
                  +1 (920) 808-1188
                </a>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm mb-2">
                © 2024 Rent Control Manager. All rights reserved.
              </p>

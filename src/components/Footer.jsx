          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="mailto:support@rentcontrol.com" className="text-gray-400 hover:text-white transition-colors">
                  support@rentcontrol.com
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          ...
          <div className="text-center mt-8 pt-8 border-t border-gray-800">
            <p className="text-gray-500 text-sm">
              Powered by <span className="text-blue-400 font-medium">Visnec</span>
            </p>
          </div>
        </div>
      </div>
